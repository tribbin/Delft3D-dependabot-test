...
subroutine check_time_interval(time_interval_start, time_interval, time_interval_end, user_time_step, time_interval_name, time_start_user)
    ...
    double precision, intent(in   ) :: time_start_user      !< Start time of the simulation
    ...
    if (time_interval > 0d0) then
        ...
        elseif (is_not_multiple(time_interval_start - time_start_user, user_time_step)) then 
            ...
            call mess(LEVEL_ERROR, msgbuf)
        elseif (is_not_multiple(time_interval_end - time_start_user, user_time_step)) then            
