...
!     Type    Name         I/O Description
      ...
      integer(kind=int_32) ::ipoint( 37) ! I  Array of pointers in pmsa to get and store the data
      integer(kind=int_32) ::increm( 37) ! I  Increments in ipoint for segment loop, 0=constant, 1=spatially varying
      ...
      integer(kind=int_32) ::ipnt( 37)   !    Local work array for the pointering
...
!     local decalarations
      ...
      integer(kind=int_32) ::ispe       ! index number of bloom algae species
      real(kind=sp) ::effi(30)   ! efficiencies per species group
