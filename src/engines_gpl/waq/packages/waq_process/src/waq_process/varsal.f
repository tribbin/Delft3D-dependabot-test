...
!>       Salinity in case of constant river discharge
      ...
      real(kind=sp) ::frcon       ! I  fraction fresh water from constant river discharge (-)
      real(kind=sp) ::frflow      ! I  fraction fresh water from variable river discharge (-)
      real(kind=sp) ::salbnd      ! I  salinity from the boundary                        (ppt)
      real(kind=sp) ::salinity    ! O  salinity                                          (ppt)
