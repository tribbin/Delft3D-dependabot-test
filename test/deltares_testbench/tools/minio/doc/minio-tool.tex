...
Optional:
\begin{guilist}
	\item[\texttt{-{}-allow-create-delete -t}] Allow the addition or removal of files in MinIO. If this is not specified the tool will only update existing files in MinIO.
\end{guilist}
...
\label{ssec:casefile}
The MinIO tool also allows for the use of a test case file specification in a comma seperated value file.
...
e112_f01_c11_waardenburg, lnx64
