...
echo "Parameters before reading :"
echo "HARBOR_REPO: ${HARBOR_REPO}"
echo "BUILD_TYPE: ${BUILD_TYPE}"
echo "INTEL_ONEAPI_VERSION: ${INTEL_ONEAPI_VERSION}"
echo "INTEL_FORTRAN_COMPILER: ${INTEL_FORTRAN_COMPILER}"
...
echo "Parameters before setting:"
echo "HARBOR_REPO: ${HARBOR_REPO}"
echo "BUILD_TYPE: ${BUILD_TYPE}"
echo "INTEL_ONEAPI_VERSION: ${INTEL_ONEAPI_VERSION}"
echo "INTEL_FORTRAN_COMPILER: ${INTEL_FORTRAN_COMPILER}"
...
echo "##teamcity[setParameter name='env.BACKUP_IMAGE_TAG' value='$BACKUP_IMAGE_TAG']"
