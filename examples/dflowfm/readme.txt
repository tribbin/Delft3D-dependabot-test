...
3. run_native_h7.sh (Copy from src/scripts_lgpl/singularity) file to run on the Deltares h7 cluster. (For dwaq testcases, the path to dwaq libraries should be added to the script.)
4. submit_singularity_h7.sh (Copy from src/scripts_lgpl/singularity) file to run an Apptainer on the Deltares h7 cluster. (For dwaq testcases, the path to dwaq libraries should be added to the script.)
